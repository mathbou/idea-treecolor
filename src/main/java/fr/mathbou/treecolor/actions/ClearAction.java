...
import fr.mathbou.treecolor.utils.ActionUtils;
...
public class ClearAction extends AnAction {
    ...
    public void update(@NotNull AnActionEvent actionEvent) {
        ...
        ActionUtils.setActionEnabled(actionEvent, projectStateService != null && projectStateService.files.isHighlighted(files));
    }
